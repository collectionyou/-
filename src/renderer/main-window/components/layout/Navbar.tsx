  ...
  return (
    ...
    >
      ...
      <Box display={{ md: 'flex' }} gap="1rem">
        <Button size="sm" mr={2} leftIcon={<CalendarIcon />} onClick={handleOpenDataview}>
          记录
        </Button>
        <Button size="sm" mr={2} leftIcon={<ChatIcon />} onClick={handleOpenDataview}>
          关键词
        </Button>
        <Button size="sm" leftIcon={<SettingsIcon />} onClick={handleOpenSettings}>
          AI API
        </Button>
      </Box>
    </Flex>
